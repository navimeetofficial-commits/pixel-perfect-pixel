...
export function Teacher({
  ...
  return (
    <motion.div
      ...
      className={`pointer-events-auto flex select-none flex-col items-end ${
    ...
    >
      <AnimatePresence>
        {speech && (
          <motion.div
            ...
            className="mb-1 max-h-[22vh] overflow-hidden max-w-[52vw] rounded-2xl rounded-br-sm border border-border bg-card px-3 py-2 text-xs leading-snug text-foreground shadow-soft sm:max-w-[240px] sm:text-sm"
          >
            {speech}
          </motion.div>
        )}
      ...
      <svg
        viewBox="0 0 220 360"
        className="h-full w-full drop-shadow-[0_14px_20px_rgba(0,0,0,0.18)]"
